 ...
 * 
 */
public class File_SentActivity extends Activity implements OnClickListener {
	private TextView title;
	private ImageView back;
	private ListView file_sent_record;
	...
	private void initData() {
		...
		MyFile[] files = db_dao.queryAllSentFilel();
		if (files != null) {
	...
	private void initView() {
		...
		title.setText("发送文件历史记录");
		file_sent_record = (ListView) findViewById(R.id.lv_sent_files);
		if (recordAdapter != null) {
			file_sent_record.setAdapter(recordAdapter);
		}
	...
	private void showDialog() {
		...
		DialogUtil.messageDialog(File_SentActivity.this, methods, "删除记录",
				"确认删除？");
	}
}
